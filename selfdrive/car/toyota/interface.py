...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    if candidate == CAR.PRIUS:
      ...
      ret.lateralTuning.pid.kpBP, ret.lateralTuning.pid.kpV = [[8.9408, 35], [0.06, 0.15]]  # 45 to 70 mph
      ret.lateralTuning.pid.kiBP, ret.lateralTuning.pid.kiV = [[8.9408, 35], [0.001, 0.01]]
      ret.lateralTuning.pid.kdBP, ret.lateralTuning.pid.kdV = [[8.9408, 35], [0.0, 0.0]]
      # ret.lateralTuning.pid.kf = 0.00003  # full torque for 20 deg at 80mph means 0.00007818594
      ret.lateralTuning.pid.kf = 0.00006908923778520113 * 0.8  # full torque for 20 deg at 80mph means 0.00007818594
      ret.lateralTuning.pid.newKfTuned = True
