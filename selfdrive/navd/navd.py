...
class RouteEngine:
  def __init__(self, sm, pm):
    ...
    self.params.put("ApiCache_NavDestinations",
                    ...
                    # b'{"id": "3", "dongle_id": "", "place_name": "Point Loma Tide Pools", "place_details": "Lands End Road, San Diego, CA 92106", "latitude": 32.670773, "longitude": -117.243830, "save_type": "recent"},'
                    b'{"id": "3", "dongle_id": "", "place_name": "Point Loma Tide Pools", "place_details": "Lands End Road, San Diego, CA 92106", "latitude": 32.668788, "longitude": -117.245258, "save_type": "recent"},'
