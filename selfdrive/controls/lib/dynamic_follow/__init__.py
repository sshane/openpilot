...
class DynamicFollow:
  ...
  def _change_cost(self, libmpc):
    ...
    change_time_x = [0, 1.5, 4]  # for three seconds after effective profile has changed
    change_mod_y = [1, 7.5, 1]  # multiply cost by multiplier to quickly change distance
  ...
  def _get_TR(self):
    ...
    if df_profile == self.df_profiles.roadtrip:
      y_dist = [1.3978, 1.4132, 1.4318, 1.4536, 1.4862, 1.5321, 1.6058, 1.6589, 1.7798, 1.8748, 1.8953, 1.9127, 1.9276]  # TRs
      profile_mod_pos = [0.92, 0.48, 0.1, 0.03]
      profile_mod_neg = [1.1, 1.4, 2.2, 2.6]
