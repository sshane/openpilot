...
class DynamicFollow:
  ...
  def _change_cost(self, libmpc):
    ...
    change_time_x = [0, 0.75, 4]  # for three seconds after effective profile has changed
    change_mod_y = [1, 10, 1]  # multiply cost by multiplier to quickly change distance
