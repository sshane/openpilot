...
class Track:
  def __init__(self, vRel, yRel, dRel):
    ...
    self.yRel = yRel
    self.dRel = dRel
v_rels = [7.027988825101453, -35, -2.0073281329557595, -38, -42, -0.4124279188166433, -4.864017389464086, -31.5, -9.684282305020197, -9.979187599100587, -38.4, -3.025854705185946, -6.347005348508485, -2.502134724290814, 3.8857648270182743, 5.3016772854121115]
