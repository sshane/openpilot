...
class LongControl():
  ...
  def update(self, active, v_ego, brake_pressed, standstill, cruise_standstill, v_cruise, v_target, v_target_future, a_target, CP, extras):
    ...
    with open('/data/longcontrol_gas_press', 'a') as f:
