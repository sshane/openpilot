...
class PathPlanner():
  def __init__(self, CP):
    ...
    self.use_static_steering_ratio = self.op_params.get('use_static_steering_ratio', default=False)
  ...
  def getSteerRatio(self, sR):
    if not travis and not self.use_static_steering_ratio:
  ...
  def update(self, sm, pm, CP, VM):
    ...
    sR = self.getSteerRatio(VM.sR)
    self.cur_state = calc_states_after_delay(self.cur_state, v_ego, angle_steers - angle_offset, curvature_factor, sR, CP.steerActuatorDelay)
