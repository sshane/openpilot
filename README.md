...
- **Dynamic params**:
  ...
  - `min_TR` **`(live!)`**: The minimum allowed following distance in seconds. Default is 0.9 seconds, the range of this param is limited from 0.8 to 1.4. This is applied to ALL profiles!
