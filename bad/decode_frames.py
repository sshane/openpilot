...
# TEST_SEG = 'C:/Users/Shane/Downloads/body-data/c81675c456f9f72d_2023-09-27--17-23-04/5/dcamera.hevc'
...
for msg in sorted(lr, key=lambda x: x.logMonoTime):
  if msg.which() == 'testJoystick':
    if len(msg.testJoystick.axes):
      ...
      train_y.append(msg.testJoystick.axes)  # left/right is idx 1, fwd/bck is idx 0
      tjs += 1
# raise Exception
print(tjs)
...
while success:
  ...
  if count % 20 == 0:
    ...
    every = not every
    img_fn = "/mnt/c/Users/Shane/bad/{}/image{:>3}_y{}_{}.png".format(train, count,
