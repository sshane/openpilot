...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {'camera_offset': Param(0.06, VT.number, 'Your camera offset to use in lane_planner.py'),
                        ...
                        'derivative_multiplier': Param(1, VT.number, '1 is 100% derivative, 0 is no derivative'),
    ...
    _live_params = ['camera_offset', 'global_df_mod', 'min_TR', 'steer_ratio', 'derivative_multiplier']
