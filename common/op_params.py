...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {'camera_offset': Param(0.06, VT.number, 'Your camera offset to use in lane_planner.py', live=True),
                        ...
                        'lane_speed_alerts': Param('off', str, 'Can be: (\'off\', \'silent\', \'audible\')\n'
                        ...
                        'use_lqr': Param(True, bool, 'Enable this to use LQR as your lateral controller over default with any car'),
                        ...
                        'standstill_hack': Param(True, bool, 'Some cars support stop and go, you just need to enable this')}
